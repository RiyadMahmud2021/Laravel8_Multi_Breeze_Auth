...
<div class="content_wrapper">
    ...
    <div class="card m-2">
        <div class="card-body" style="color:gray;font-weight: 400; font-size: 15px; font-family: 'Open Sans', sans-serif">
            As Admin, <br/> Your name is <strong> {{Auth::guard('admin')->user()->name}} </strong> and email is <strong> {{Auth::guard('admin')->user()->email}}. </strong>
            Don't forget your <strong>password !!!</strong>
        </div> 
    </div> 
